...
export async function GET(
    ...
    try {
        ...
        // PUSAT, FINANCE, DC, FINANCE_DC, FINANCE_ALL, MANAGER_PUSAT can check outstanding
        if (!["PUSAT", "FINANCE", "DC", "FINANCE_DC", "FINANCE_ALL", "MANAGER_PUSAT"].includes(session.user.role)) {
